...
if(isset($_POST['search']))
{
    ...
    $search_Query = "SELECT * FROM userlogin WHERE id = '$data[0]'";
...
{
    $data = getPosts();
    $insert_Query = "INSERT INTO userlogin (`username`, `password`) VALUES ('$data[1]','$data[2]')";
    try{
...
{
    $data = getPosts();
    $delete_Query = "DELETE FROM userlogin WHERE `id` = '$data[0]'";
    try{
...
{
    $data = getPosts();
    $update_Query = "UPDATE userlogin SET `username`='$data[1]',`password` = '$data[2]' WHERE `id` = '$data[0]'";
    try{
...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    padding-top: 50px; color:black"> ADMINISTRATION DATABASE DATA</h1>

    <p style="text-decoration:underline;font-weight:bolder">SIGNIN (INSERT,UPDATE,DELETE,SEARCH FORM)</p>
